	...
	<div class="container-fullwidth">
		<div class="row">
			<div class="jumbotron col-md-6 col-md-offset-3"
				...
				<h2 style="margin-bottom: 30px" class="col-md-10 col-md-offset-1 bg-info">Sign
					into your account</h2>
				<div class="row">
						...
						<form method="post" action="LoginServlet">
							...
							<input type="submit" class="btn btn-primary btn-lg"
								...
								to your account"></input>
                                                        ...
                                                        Forget password?<a href="forgetpassword.jsp" class="alert-link"> Click Here</a>
					</div>
				</div>
			</div>
		</div>
